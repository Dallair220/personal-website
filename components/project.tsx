...
export default function Project({ title, description, tags, imageUrl }: ProjectProps) {
  ...
  return (
    ...
    >
      <article className='bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 transition sm:group-even:even:pl-8'>
